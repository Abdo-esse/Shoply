      ...
      <!-- product ${element.id} -->
            <div id="card-prod-${element.id}" class="all-fav-card bg-white rounded-2xl p-5 cursor-pointer relative hover:shadow	">
              <div id="fav-btn-${element.id}" onclick="favBtn(this)"
                class="bg-red-600 fav-btn-class group bg-gray-100 w-10 h-10 flex items-center justify-center rounded-full cursor-pointer absolute top-4 right-4  z-50  hover:bg-green-600">
