  ...
  .then(data => {
   console.log(data)
    ...
    for (let i = 0; i < data.length; i++) {
      ...
      add.innerHTML += `<div
            class="bg-white rounded-2xl p-5 cursor-pointer relative hover:shadow"
          >
            <div
              class="bg-gray-100 w-10 h-10 flex items-center justify-center rounded-full cursor-pointer absolute top-4 right-4 z-50"
            >
              <svg
            ...
            <div>
              ...
              <div class="flex justify-between align-middle mt-4">
                <h4 class="text-lg text-gray-800 font-bold h-full my-auto">
                ${price}
                </h4>
                <button
